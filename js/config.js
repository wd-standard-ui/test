...
export const LIFF_ID = "2006490627-xn8XaYD1"; // ตามที่ระบุ
// Endpoint ของ Edge Function (เมื่อต่อกับ Supabase Functions แล้วใช้ path นี้)
export const EDGE_LOGIN_ENDPOINT = "/functions/v1/line-login";
